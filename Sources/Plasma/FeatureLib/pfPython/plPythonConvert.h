...
namespace plPython
{
    ...
    namespace _detail
    {
        ...
        constexpr inline void ConvertToTuple(PyObject* result, std::tuple<_TupleArgsT...>&& tuple)
        {
    ...
    constexpr inline PyObject* ConvertFrom(std::tuple<_TupleArgsT...>&& tuple)
    {
        using _TupleT = std::decay_t<decltype(tuple)>;

        PyObject* result = PyTuple_New(std::tuple_size_v<_TupleT>);
        _detail::ConvertToTuple<0>(result, std::forward<_TupleT>(tuple));
        return result;
    }
    ...
    template<typename... _TupleArgsT>
    constexpr inline PyObject* ConvertFrom(ToTuple_Type, _TupleArgsT... args)
    {
        return ConvertFrom(std::make_tuple<_TupleArgsT...>(std::forward<_TupleArgsT>(args)...));
    }
};
