...
{
public:
    plPickSwimCurrentInterfaceButtonParam(ParamID id, ST::string string);
...
{
public:
    plPickClusterComponentButtonParam(ParamID id, ST::string string);
...
{
public:
    plPickAnimationButtonParam(ParamID id, ST::string string);
...
{
public:
    plPickBehaviorButtonParam(ParamID id, ST::string string);
...
{
public:
    plPickMaterialButtonParam(ParamID id, ST::string string);
...
public:
    plPickMaterialAnimationButtonParam(ParamID id, ST::string string);
...
{
public:
    plPickGrassComponentButtonParam(ParamID id, ST::string string);
